        ...
        <> 
            <section className='c-introduction'>
                <div className='wrapper c-introduction__wrapper'>
                    ...
                    <h1 className='animation'>Meu nome é <span className='c-introduction__special_Text'>Arthur</span>, um <span className='c-introduction__special_Text'>desenvolvedor web</span></h1>
